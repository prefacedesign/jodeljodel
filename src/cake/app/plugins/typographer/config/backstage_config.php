...
$palette = array(
	...
	'input_error_bg'	 => new Color(255,235,220),
	'input_error_fg'	 => new Color(  0,  0,  0),
	'error_message'		 => new Color(237, 28, 36),
	'success_message'	 => new Color(  0,132, 54),
	'error_popin'		 => new Color(255,213,185),
	'normal_popin'	     => new Color(216,229,255),
	'progress_popin'	 => new Color(234,229,219),
	'popin_bg'			 => new Color(255,244,127),
	'popin_fg'			 => new Color(  0,  0,  0),
	'popin_shadow'		 => new Color(  0,  0,  0),
